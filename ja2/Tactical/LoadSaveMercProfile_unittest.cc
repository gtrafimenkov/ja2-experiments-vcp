...
//   ExtractImpProfileFromFile("unittests/saves/vanilla-russian/IMP.dat", &profileId,
//   &portraitNumber,
//                             p);
...
//   int32_t profileId;
//   int32_t portraitNumber;
//   ExtractImpProfileFromFile("unittests/saves/strac-macos/imp.dat", &profileId, &portraitNumber,
//   p); EXPECT_EQ(profileId, PLAYER_GENERATED_CHARACTER_ID); EXPECT_EQ(portraitNumber, 0);
